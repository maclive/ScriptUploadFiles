...
function LoadHtml2Div(parameter) {
	...
	$.get('ajax/index.php?load&title&__'+parameter, function(data, status) {if (status == 'success') $("#MainTitle").html(data);});
    $.get('ajax/index.php?load&_'+parameter, function(responseTxt, statusTxt) {
